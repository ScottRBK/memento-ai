"""
PostgreSQL repository for Document data access operations
"""
...
from app.repositories.postgres.postgres_tables import DocumentsTable
...
class PostgresDocumentRepository:
    """Repository for Document operations in PostgreSQL"""
    ...
    def __init__(self, db_adapter: PostgresDatabaseAdapter):
        ...
        logger.info("Postgres document repository initialized")
