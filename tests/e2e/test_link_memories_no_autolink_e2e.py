...
async def test_link_memories_basic_e2e(docker_services, mcp_server_url):
    ...
    async with Client(mcp_server_url) as client:
        ...
        query_result2 = await client.call_tool('execute_forgetful_tool', {
            'tool_name': 'query_memory', 'arguments': {'query':
...
async def test_link_memories_batch_e2e(docker_services, mcp_server_url):
    ...
    async with Client(mcp_server_url) as client:
        source_result = await client.call_tool('execute_forgetful_tool', {
            'tool_name': 'create_memory', 'arguments': {'title':
        ...
        target1_result = await client.call_tool('execute_forgetful_tool', {
            'tool_name': 'create_memory', 'arguments': {'title':
        ...
        target2_result = await client.call_tool('execute_forgetful_tool', {
            'tool_name': 'create_memory', 'arguments': {'title':
        ...
        target3_result = await client.call_tool('execute_forgetful_tool', {
            'tool_name': 'create_memory', 'arguments': {'title':
...
async def test_link_memories_persistence_e2e(docker_services, mcp_server_url):
    ...
    async with Client(mcp_server_url) as client:
        memory1_result = await client.call_tool('execute_forgetful_tool', {
            'tool_name': 'create_memory', 'arguments': {'title':
        ...
        memory2_result = await client.call_tool('execute_forgetful_tool', {
            'tool_name': 'create_memory', 'arguments': {'title':
        ...
        assert link_result.data is not None
        assert memory2_id in link_result.data["linked_memory_ids"], f'Expected [{memory2_id}] but got {link_result.data["linked_memory_ids"]}'
        query1_result = await client.call_tool('execute_forgetful_tool', {
            'tool_name': 'query_memory', 'arguments': {'query':
        ...
        query2_result = await client.call_tool('execute_forgetful_tool', {
            'tool_name': 'query_memory', 'arguments': {'query':
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_link_memories_partial_failure_e2e(docker_services,
    mcp_server_url):
    ...
    async with Client(mcp_server_url) as client:
        ...
        assert source_result.data is not None
        source_id = source_result.data["id"]
        target_result = await client.call_tool('execute_forgetful_tool', {
            'tool_name': 'create_memory', 'arguments': {'title':
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_link_memories_duplicate_prevention_e2e(docker_services,
    mcp_server_url):
    ...
    async with Client(mcp_server_url) as client:
        ...
        assert memory2_result.data is not None
        memory2_id = memory2_result.data["id"]
        first_link_result = await client.call_tool('execute_forgetful_tool',
            {'tool_name': 'link_memories', 'arguments': {'memory_id':
            memory1_id, 'related_ids': [memory2_id]}})
        ...
        second_link_result = await client.call_tool('execute_forgetful_tool',
            {'tool_name': 'link_memories', 'arguments': {'memory_id':
            memory1_id, 'related_ids': [memory2_id]}})
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_link_memories_invalid_source_id_e2e(docker_services,
    mcp_server_url):
