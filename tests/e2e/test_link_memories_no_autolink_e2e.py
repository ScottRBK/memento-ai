...
@pytest.mark.e2e
async def test_unlink_memories_basic_e2e(mcp_client):
    ...
    query_result1_after = await mcp_client.call_tool('execute_forgetful_tool', {
        'tool_name': 'query_memory', 'arguments': {'query':
        'Functional Programming Concepts', 'query_context':
    ...
    query_result2_after = await mcp_client.call_tool('execute_forgetful_tool', {
        'tool_name': 'query_memory', 'arguments': {'query':
...
@pytest.mark.e2e
async def test_unlink_memories_not_found_e2e(mcp_client):
