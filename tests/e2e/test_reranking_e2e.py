...
@pytest.mark.asyncio
async def test_reranking_reorders_by_context_e2e(docker_services, mcp_server_url):
    """
...
@pytest.mark.asyncio
async def test_reranking_with_different_contexts_e2e(docker_services, mcp_server_url):
    """
