...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_graph_empty_returns_200(docker_services, server_base_url):
    """GET /api/v1/graph returns empty graph initially."""
    async with httpx.AsyncClient() as client:
        response = await client.get(f"{server_base_url}/api/v1/graph")
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_graph_with_all_node_types(docker_services, server_base_url):
    """GET /api/v1/graph returns all 5 node types: memory, entity, project, document, code_artifact."""
    async with httpx.AsyncClient() as client:
        # Create a project
        project_resp = await client.post(f"{server_base_url}/api/v1/projects", json={
        ...
        doc_resp = await client.post(f"{server_base_url}/api/v1/documents", json={
        ...
        artifact_resp = await client.post(f"{server_base_url}/api/v1/code-artifacts", json={
        ...
        mem_resp = await client.post(f"{server_base_url}/api/v1/memories", json={
        ...
        # Create an entity
        entity_resp = await client.post(f"{server_base_url}/api/v1/entities", json={
        ...
        await client.post(f"{server_base_url}/api/v1/entities/{entity_id}/memories", json={
            "memory_id": memory_id
        })
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_graph_node_types_filter(docker_services, server_base_url):
    """GET /api/v1/graph?node_types=memory,entity returns only specified types."""
    async with httpx.AsyncClient() as client:
        # Create a project (should be excluded when filtering)
        await client.post(f"{server_base_url}/api/v1/projects", json={
        ...
        response = await client.get(f"{server_base_url}/api/v1/graph?node_types=memory,entity")
        assert response.status_code == 200
        data = response.json()
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_subgraph_from_memory_center(docker_services, server_base_url):
    ...
    async with httpx.AsyncClient() as client:
        ...
        # Get subgraph
        response = await client.get(f"{server_base_url}/api/v1/graph/subgraph?node_id=memory_{memory_id}")
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_subgraph_from_project_center(docker_services, server_base_url):
    ...
    async with httpx.AsyncClient() as client:
        ...
        response = await client.get(f"{server_base_url}/api/v1/graph/subgraph?node_id=project_{project_id}")
        assert response.status_code == 200
        data = response.json()
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_subgraph_from_document_center(docker_services, server_base_url):
    ...
    async with httpx.AsyncClient() as client:
        ...
        response = await client.get(f"{server_base_url}/api/v1/graph/subgraph?node_id=document_{document_id}")
        assert response.status_code == 200
        data = response.json()
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_subgraph_from_code_artifact_center(docker_services, server_base_url):
    ...
    async with httpx.AsyncClient() as client:
        ...
        response = await client.get(f"{server_base_url}/api/v1/graph/subgraph?node_id=code_artifact_{artifact_id}")
        assert response.status_code == 200
        data = response.json()
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_subgraph_cycle_detection_postgresql(docker_services, server_base_url):
    """PostgreSQL CTE handles cycles without infinite loops (uses ARRAY cycle detection)."""
    async with httpx.AsyncClient() as client:
        # Create memories that form a cycle: A -> B -> C -> A
        mem_a_resp = await client.post(f"{server_base_url}/api/v1/memories", json={
        ...
        mem_b_resp = await client.post(f"{server_base_url}/api/v1/memories", json={
        ...
        mem_c_resp = await client.post(f"{server_base_url}/api/v1/memories", json={
        ...
        await client.post(f"{server_base_url}/api/v1/memories/{mem_a_id}/links", json={
            "related_ids": [mem_b_id]
        })
        await client.post(f"{server_base_url}/api/v1/memories/{mem_b_id}/links", json={
            "related_ids": [mem_c_id]
        })
        await client.post(f"{server_base_url}/api/v1/memories/{mem_c_id}/links", json={
            "related_ids": [mem_a_id]
        })

        # Should complete without infinite loop, even with depth=3
        response = await client.get(f"{server_base_url}/api/v1/graph/subgraph?node_id=memory_{mem_a_id}&depth=3")
        assert response.status_code == 200
        data = response.json()
        ...
        # Note: Other memories may appear from auto-linking, but our cycle nodes must be unique
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_subgraph_multi_hop_traversal(docker_services, server_base_url):
    ...
    async with httpx.AsyncClient() as client:
        ...
        response = await client.get(
            f"{server_base_url}/api/v1/graph/subgraph?node_id=project_{project_id}&depth=2"
        )
        assert response.status_code == 200
        data = response.json()
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_subgraph_meta_includes_all_new_counts(docker_services, server_base_url):
...
@pytest.mark.e2e
@pytest.mark.asyncio
async def test_subgraph_node_types_filter_postgresql(docker_services, server_base_url):
    ...
    async with httpx.AsyncClient() as client:
        ...
        response = await client.get(
            f"{server_base_url}/api/v1/graph/subgraph?node_id=memory_{memory_id}&node_types=memory"
        )
        assert response.status_code == 200
        data = response.json()
        ...
        response = await client.get(
            f"{server_base_url}/api/v1/graph/subgraph?node_id=memory_{memory_id}&node_types=memory,project"
        )
        assert response.status_code == 200
        data = response.json()
