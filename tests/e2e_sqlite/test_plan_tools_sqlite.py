...
async def test_create_plan_e2e(mcp_client):
    ...
    project_id = await _create_project(mcp_client, "plan-create-proj")
...
async def test_get_plan_e2e(mcp_client):
    ...
    project_id = await _create_project(mcp_client, "plan-get-proj")
...
async def test_list_plans_e2e(mcp_client):
    ...
    project_id = await _create_project(mcp_client, "plan-list-proj")
...
async def test_update_plan_e2e(mcp_client):
    ...
    project_id = await _create_project(mcp_client, "plan-update-proj")
...
async def test_plan_create_defaults_e2e(mcp_client):
    ...
    project_id = await _create_project(mcp_client, "plan-defaults-proj")
...
async def test_plan_lifecycle_e2e(mcp_client):
    ...
    project_id = await _create_project(mcp_client, "plan-lifecycle-proj")
...
async def test_plan_invalid_status_transition_e2e(mcp_client):
    ...
    project_id = await _create_project(mcp_client, "plan-invalid-trans-proj")
...
async def test_list_plans_filter_by_status_e2e(mcp_client):
    ...
    project_id = await _create_project(mcp_client, "plan-filter-status-proj")

    # Create a draft and an active plan
    await mcp_client.call_tool(
        "execute_forgetful_tool",
        {
            "tool_name": "create_plan",
